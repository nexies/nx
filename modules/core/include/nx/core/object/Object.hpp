...
#ifndef NX_CORE_OBJECT_HPP
#define NX_CORE_OBJECT_HPP

#include <nx/core/types/Result.hpp>

#include <nx/core/object/Property.hpp>
#include <nx/core/object/Signal.hpp>
#include <nx/core/object/ConnectionInfo.hpp>
#include <nx/core/functional/Callable.hpp>
...
namespace nx {
    ...
    bool connect(Sender* sender, Signal&& signal, Receiver* receiver, Slot&& slot, uint8_t flags)
    {
        ...
        sender, detail::get_function_id(signal),
        receiver, detail::get_function_id(slot),
    ...
    void emit(Sender* sender, Signal signal, Args&&... args)
    {
        ...
        auto sender_id = Connection::MakeId(sender, detail::get_function_id(signal), 0, 0);
