...
// C++11-compatible nested namespace (C++17 syntax: namespace nx::detail)
namespace nx { namespace detail {

    template <class Enum,
              typename std::underlying_type<Enum>::type AllMask =
                  std::numeric_limits<typename std::underlying_type<Enum>::type>::max()>
    class make_flags_from_enum {
        static_assert(std::is_enum<Enum>::value,
                      "make_flags_from_enum<T>: T must be an enum type.");
    ...
    public:
        ...
        constexpr bool has(Enum e) const noexcept {
        ...
        constexpr make_flags_from_enum& operator|=(make_flags_from_enum rhs) noexcept {
            bits_ = (bits_ | rhs.bits_) & mask_u(); return *this;
        }
        constexpr make_flags_from_enum& operator&=(make_flags_from_enum rhs) noexcept {
            bits_ = (bits_ & rhs.bits_) & mask_u(); return *this;
        }
        ...
        friend constexpr make_flags_from_enum operator~(make_flags_from_enum a) noexcept {
            a.bits_ = (~a.bits_) & mask_u(); return a;
        }

        friend constexpr make_flags_from_enum operator|(make_flags_from_enum a, make_flags_from_enum b) noexcept { a |= b; return a; }
        friend constexpr make_flags_from_enum operator&(make_flags_from_enum a, make_flags_from_enum b) noexcept { a &= b; return a; }
        friend constexpr make_flags_from_enum operator^(make_flags_from_enum a, make_flags_from_enum b) noexcept { a ^= b; return a; }
        ...
        friend constexpr bool operator==(make_flags_from_enum a, make_flags_from_enum b) noexcept { return a.bits_ == b.bits_; }
        friend constexpr bool operator!=(make_flags_from_enum a, make_flags_from_enum b) noexcept { return !(a == b); }

        friend constexpr bool operator==(make_flags_from_enum a, Enum b) noexcept { return a.bits_ == (to_u(b) & mask_u()); }
        friend constexpr bool operator!=(make_flags_from_enum a, Enum b) noexcept { return !(a == b); }

        friend constexpr bool operator==(Enum a, make_flags_from_enum b) noexcept { return b == a; }
        friend constexpr bool operator!=(Enum a, make_flags_from_enum b) noexcept { return !(b == a); }

        friend constexpr bool operator==(Enum a, Enum b) noexcept {
