...
namespace nx {
    ...
    error_descriptor::error_descriptor(const nx::source_location& location,
    ...
    {
        ptr->comment  = {};
        ptr->location = g_undefined_location;
        ptr->category = nullptr;
        pool_free(ptr);
    }
