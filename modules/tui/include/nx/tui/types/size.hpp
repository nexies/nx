...
namespace nx::tui {
    ...
    struct size {
        ...
        operator==(const size &o) const noexcept { return height == o.height && width == o.width; }

        NX_NODISCARD constexpr bool
        operator!=(const size &o) const noexcept { return !(*this == o); }
    };

    template<typename T = int>
    NX_NODISCARD constexpr size<T>
