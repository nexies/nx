function(nx_make_module_version)
    ...
    if(_NXV_VERSION)
        ...
        list(GET VERSION_LIST 0 NX_${_name_up}_VERSION_MAJOR)
        list(GET VERSION_LIST 1 NX_${_name_up}_VERSION_MINOR)
        list(GET VERSION_LIST 2 NX_${_name_up}_VERSION_PATCH)

        set(NX_${_name_up}_VERSION_STR "${_NXV_VERSION}")
        set_property(GLOBAL PROPERTY NX_${_name_up}_VERSION_STR "${_NXV_VERSION}")
    endif()

    if(DEFINED NX_${_name_up}_VERSION_STR)
